...
5. 最终目标是未来受控实盘赚钱
6. 新线程默认按“按路线自主推进、完成阶段目标后再汇报、完成验证、自动 commit 一次”的仓库规则工作
7. 优先维持 Mac mini + 本地服务长期稳定运行，再推进能力优化
...
4. `curl http://127.0.0.1:8000/api/v1/command`
5. 查看最近日志与当前 blockers
6. 打开最新的：
   - `docs/PROJECT_CONTEXT.md`
   - `docs/IMPLEMENTATION_STATUS.md`
7. 根据运行状态、文档路线、测试缺口和当前 blockers，自主选择当前最有价值的同主题任务
8. 在同主题内连续推进，直到阶段目标收口，再向用户汇报
...
- 优先修复影响长期运行和主链路闭环的问题
- 再围绕当前路线连续推进同主题改动
- 达到阶段目标后再汇报，而不是每个小 patch 后停下

后续优先方向：
- 多标的并行研究
- 有限模拟盘席位
- 新知识字段继续收口到 quality report / API / 前端
- 修复 API 集成测试中的空数据问题
