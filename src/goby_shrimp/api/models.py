...
class EventRecord(Base):
    ...
    market_scope: Mapped[str] = mapped_column(String(16), nullable=False, default="CN", index=True)
...
class DailyEventDigest(Base):
    ...
    market_scope: Mapped[str] = mapped_column(String(16), nullable=False, default="CN")
    symbol_scope: Mapped[str] = mapped_column(String(32), nullable=False, default="*")
