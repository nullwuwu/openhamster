...
def risk_manager_llm_system_prompt() -> str:
    return (
        ...
        'Score contextual fit between 0 and 100 and explain the score briefly. '
        'Hard gates are enforced elsewhere and must never be overridden.'
    )


def build_risk_manager_llm_payload(*, proposal: dict[str, Any], debate_report: dict[str, Any], evidence_pack: dict[str, Any], market_snapshot: dict[str, Any], event_digest: dict[str, Any]) -> dict[str, Any]:
    return {
